function varargout = mainCVAP6(varargin)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mainCVAP6_OpeningFcn, ...
                   'gui_OutputFcn',  @mainCVAP6_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mainCVAP6 is made visible.
function mainCVAP6_OpeningFcn(hObject, eventdata, handles, varargin)

% Choose default command line output for mainCVAP6
...
function varargout = mainCVAP6_OutputFcn(hObject, eventdata, handles)
...
dname = {'PAM', 'K-means', 'Hierarchical-single', 'Hierarchical-complete', ...
                'Hierarchical-centroid', 'SOM', 'Neural Gas', 'New algorithm'};
set(hObject, 'String', dname); 
...
dname = {'leuk72_3k.txt', 'iris.txt'};
file = dname{1}; 
data = load(['datafile\' file]);
R = ['Running state: Default data set ' file ' is loaded, true k = 3.'];
valid_data_load;
